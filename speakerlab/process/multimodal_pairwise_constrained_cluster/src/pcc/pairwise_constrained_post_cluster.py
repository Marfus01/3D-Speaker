...
class CustomKMeans:
    ...
    def __init__(self,
        ...
        Constructor of the cluster.
            A custom kmeans cluster with any distance measure from scipy.spatial.distance can be used.
        ...
        Args:
            ...
            custom_dist: str or callable. custom distance measure to use.
                         if a string, "cosine", "euclidean", "mahalanobis", or any other distance functions
    ...
    def predict(self, embeddings):
        ...
        if self.max_iter <= 0:
            raise ValueError(
                f"Number of iterations should be a positive number, got {self.max_iter} instead"
            )
        ...
        for iter_idx in range(self.max_iter + 1):
            ...
            if prev_mean_dist >= mean_distance >= (1 - self.tol) * prev_mean_dist or iter_idx == self.max_iter:
                break
