...
from speakerlab.process.cluster import summary_cluster_results, reset_cluster_ids, align_clusters2clusters, align_samples2clusters
import json
...
def labels_nested_hmm_full_smooth(S_hat_onehot, F_hat, X_onehot, S_potential_list, F_potential_list, lengths, 
    ...
    np.save(os.path.join(result_dir, f'cluster_results_face_states_obs.npy'), F_hat)
...
def audio_vision_func_vad_mf(local_wav_list, audio_embs_dir, visual_embs_dir, result_dir, config):
    ...
    ## HMM_nested_X 平滑
    labels_nested_hmm_full_smooth(S_hat_onehot, F_hat, X_onehot, S_potential_list, F_potential_list, alengths, audio_seg_ids, result_dir, flag_has_neg1=flag_has_neg1)
