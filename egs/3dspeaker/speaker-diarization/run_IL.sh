...
bash /data/home/scv7387/run/tv_series_plus/3D-Speaker/egs/3dspeaker/speaker-diarization/run_video.sh --stage 1 --tv_name "$tv_name" --language $language --data_root "$data_root" --master_port 29767